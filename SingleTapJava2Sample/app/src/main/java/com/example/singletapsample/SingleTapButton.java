...
public class SingleTapButton extends MaterialButton {
    private static final String TAG = "SingleTapButton";
    private long lastClickTime = 0;
    private long clickDisablePeriod = 2000; // クリック無効期間 (ミリ秒)

    public SingleTapButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
